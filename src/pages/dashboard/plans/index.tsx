...
const History = () => {
  ...
  console.log("🚀 ~ Plan page ~ subscription:", subscription);
            ...
            <Grid container sx={{ paddingLeft: "0px", paddingRight: "0px" }}>
              ...
              >
                ...
                >
                  ...
                  >
                    <Link
                      href="/your_billing_overview"
                      style={{ textDecoration: "none" }}
                    >
                      <Typography
                        sx={{
                          fontFamily: "Quicksand",
                          fontSize: { xs: "32px", md: "56.4px" },
                          lineHeight: { sm: "70.5px", xs: "35px" },
                          fontWeight: "600",
                          color: "#000000",
                        }}
                      >
                    ...
                    <Box sx={{ paddingTop: { xs: "20px", sm: "0px" } }}>
                      <Button
                        ...
                        sx={{
                          ...
                          fontFamily: "Inter",
                          boxShadow: "none",
                          padding: { sm: "15px 25px", xs: "10px 20px" },
                  ...
                  <Box sx={{ padding: "60px 0px" }}>
                    <Grid container spacing={1}>
                      <Grid item xs={12} md={3} sm={6}>
                        <Box
                          sx={{
                            padding: { sm: "15px 20px", xs: "10px 20px" },
                      ...
                      <Grid item xs={12} md={3} sm={6}>
                        ...
                        >
                          ...
                          >
                            {formatDate(subscription?.planExpiry as string) ??
                              "unknown"}
                          </Typography>
                        </Box>
                      </Grid>
                      <Grid item xs={12} md={3} sm={6}>
                        ...
                        >
                          ...
                          >
                            {`${subscription?.creditsRemains ?? 0} words`}
                          </Typography>
                        </Box>
                      </Grid>
                      <Grid item xs={12} md={3} sm={6}>
                        ...
                        >
                          ...
                          >
                            {`${subscription?.imagesGenerated ?? 0} Images`}
                          </Typography>
                        </Box>
                      </Grid>
                    </Grid>
                  ...
                  <Box
                    sx={{
                      padding: { sm: "50px 60px", xs: "30px 15px" },
                        ...
                        >
                          ...
                          >
                            <Image
                              ...
                              className={Hero.plansImage}
                            />
                            <Box
                              sx={{ paddingLeft: { xs: "10px", sm: "25px" } }}
                            >
                              <Typography
                                sx={{
                                  fontFamily: "Quicksand",
                                  fontSize: { sm: "28.2px", xs: "25px" },
                                  fontWeight: "700",
                                  lineHeight: "35.25px",
                                  color: "#000000",
                                }}
                              ...
                              <Typography
                                sx={{
                                  fontFamily: "Quicksand",
                                  fontSize: { sm: "22.2px", xs: "18px" },
                                  fontWeight: "600",
                                  lineHeight: { sm: "35.25px", xs: "28px" },
                                  color: "#515151",
                                }}
                              >
                      ...
                      <Grid xs={12} md={6} sx={{ paddingBottom: "40px" }}>
                        ...
                        >
                          ...
                          >
                            ...
                            />
                            <Box
                              sx={{ paddingLeft: { sm: "25px", xs: "10px" } }}
                            >
                              <Typography
                                sx={{
                                  fontFamily: "Quicksand",
                      ...
                      <Grid xs={12} md={6} sx={{ paddingBottom: "20px" }}>
                        ...
                        >
                          ...
                          >
                            ...
                            />
                            <Box
                              sx={{ paddingLeft: { sm: "25px", xs: "15px" } }}
                            >
                              <Typography
                                sx={{
                                  fontFamily: "Quicksand",
                                  fontSize: { sm: "28.2px", xs: "22px" },
                                  fontWeight: "700",
                                  lineHeight: "35.25px",
                                  color: "#000000",
                                }}
                      ...
                      <Grid xs={12} md={6} sx={{ paddingBottom: "40px" }}>
                        ...
                        >
                          ...
                          >
                            ...
                            />
                            <Box
                              sx={{ paddingLeft: { xs: "15px", sm: "25px" } }}
                            >
                              <Typography
                                sx={{
                                  fontFamily: "Quicksand",
